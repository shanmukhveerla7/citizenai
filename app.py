...
# Language translations for citizen AI assistant
LANGUAGES = {
    "en": {
        "title": "🌆 Citizen AI Assistant",
        "subtitle": "Ask about traffic, services, environment, and infrastructure.",
        ...
        "footer": "© 2025 Citizen AI Assistant | Built with ❤️ using Streamlit & Watsonx",
        "save_profile": "Save Profile",
        "generate_ai_report": "Generate AI Report Summary",
        "export_pdf": "📄 Export Report as PDF"
    },
    "es": {
        "title": "🌆 Asistente Ciudadano IA",
        "subtitle": "Pregunte sobre tráfico, servicios y medio ambiente.",
        "home_welcome": "🌆 Bienvenido al Asistente de Ciudadano Inteligente",
        "chat": "🤖 Chatbot con IA",
        ...
        "footer": "© 2025 Asistente Ciudadano | Hecho con ❤️ usando Streamlit & Watsonx",
        "save_profile": "Guardar Perfil",
        "generate_ai_report": "Generar Resumen con IA",
        "export_pdf": "📄 Exportar Informe como PDF"
    },
    "fr": {
        "title": "🌆 Assistant Citoyen IA",
        "subtitle": "Posez des questions sur le trafic, les services et l'environnement.",
        "home_welcome": "🌆 Bienvenue dans votre assistant citoyen intelligent",
        ...
        "footer": "© 2025 Assistant Citoyen IA | Réalisé avec ❤️ en utilisant Streamlit & Watsonx",
...
# Page config
st.set_page_config(page_title="🌆 Citizen AI Assistant", layout="wide", page_icon="🌆")
...
st.markdown("""
    <style>
        ...
        button { background-color: #8e44ad !important; color: white; border: none; padding: 10px 20px; font-size: 14px; border-radius: 8px; cursor: pointer; transition: all 0.3s ease; }
        button:hover { background-color: #732d91 !important; transform: translateY(-2px); }
        .user-bubble {
        ...
        .ai-analysis { background-color: #fefefe; padding: 16px; border-left: 4px solid #8e44ad; border-radius: 8px; box-shadow: 0 2px 6px rgba(0,0,0,0.05); font-size: 14px; }
    </style>
...
def export_city_report():
    ...
    pdf.cell(0, 10, txt="CitizenAI - City Analysis Report", ln=True, align='C')
    pdf.ln(10)
...
# ------------------------------ USER PROFILE ------------------------------
    ...
    role = st.selectbox("Role", ["Mayor", "Engineer", "Planner", "Analyst", "Citizen"])
...
# ------------------------------ TRAFFIC MONITOR ------------------------------
    ...
    query = st.text_area("Describe your traffic issue or ask a question:")
...
# ------------------------------ PROGRESS REPORTS ------------------------------
    ...
    if st.button(LANGUAGES[lang]["generate_ai_report"]):
        ...
        st.markdown(f'<div class="ai-analysis">{summary}</div>', unsafe_allow_html=True)
